...
//html canvas variables
  ...
  const ctxt = canvas.getContext('2d',{ alpha: true });

  let wHeight;
  let wWidth;

  /*let egg = new Image();
  egg.src = "eggframe.svg";*/ //animated svg does not render to canvas :(

  let pixelRescale = window.devicePixelRatio;
...
function init(){
  ...
  //stop scrolling in or out too much
